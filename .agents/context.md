...
│   │   ├── ibtracs_forecast.py ← IBTrACSForecastLightningModule (BaseLightningModule subclass; masks ibtracs values/coords with learned tokens, MSE loss)
│   │   ├── base_module.py ← BaseLightningModule (general WindowBatch→WindowBatch)
