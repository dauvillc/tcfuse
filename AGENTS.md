...
| MoTiF backbone (dual value/coord tokens, cross-source + self-attention + MLP blocks, coords conditioning every layer; encoders_motif / motif / decoders_motif) | [`.agents/motif.md`](.agents/motif.md) |
